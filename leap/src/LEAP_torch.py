...
class Projector(torch.nn.Module):
    def __init__(self, forward_project=None, use_static=False, use_gpu=False, gpu_device=None, batch_size=1):
        ...
        if self.use_gpu:
            leap.set_gpu(self.param_id, self.gpu_device.index)
    ...
    def set_gpu(self, which):
        ...
        return leap.set_gpu(self.param_id, self.gpu_device.index)
