...
Test_FOLDER=medicalCT_$INDEX
############################################################.
echo "Testing on Folder: medicalCT_$INDEX Using $NUMANGLES Angles"

SUBJETR_ID="--sub_id S_$INDEX"
ANGLES="--num_angs $NUMANGLES"
DATA_DIR="--data_dir ./dataset/CKC/"
...
CONDTIONS="--weighted_condition False --use_condtion rls"
MODEL_PATH="--model_path ./model_zoo/model512_all.pt"
SAMPLE_FLAGS="--batch_size 1 --num_samples 300 --sampler ddim --timestep_respacing ddim40 --prox_solver cgrad"
###########################################################
